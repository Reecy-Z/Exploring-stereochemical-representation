...
for epoch in range(EPOCHS):
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MAD_G_subset_train_target_pred_'+ 'test_sub-cat'+ '.csv',target_pred_train,delimiter=',')
        np.savetxt('MAD_G_subset_mae_train_'+ 'test_sub-cat' + '.csv',mae_train_total,delimiter=',')
