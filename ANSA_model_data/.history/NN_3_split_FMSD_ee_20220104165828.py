...
for epoch in range(EPOCHS):
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('FMSD_ee_subset_train_target_pred_'+ 'test_cat'+ '.csv',target_pred_train,delimiter=',')
        np.savetxt('FMSD_ee_subset_r2_train_'+ 'test_cat' + '.csv',mae_train_total,delimiter=',')
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('FMSD_ee_subset_test_target_pred_'+ 'test_cat' + '.csv',target_pred_test,delimiter=',')
        np.savetxt('FMSD_ee_subset_r2_test_'+ 'test_cat' + '.csv',mae_test_total,delimiter=',')
