...
train_loader,valid_loader = get_Train_Test(X=[Train_384,Test_304],Y=[Train_G_384,Test_G_304])
...
for epoch in range(EPOCHS):
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MALD_ee_subset_train_target_pred_'+ 'test_cat'+ '.csv',target_pred_train,delimiter=',')
        np.savetxt('MALD_ee_subset_r2_train_'+ 'test_cat' + '.csv',mae_train_total,delimiter=',')
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MALD_ee_subset_test_target_pred_'+ 'test_cat' + '.csv',target_pred_test,delimiter=',')
        np.savetxt('MALD_ee_subset_r2_test_'+ 'test_cat' + '.csv',mae_test_total,delimiter=',')
