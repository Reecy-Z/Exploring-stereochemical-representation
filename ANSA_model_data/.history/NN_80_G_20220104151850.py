...
for epoch in range(EPOCHS):
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MALD_G_80_train_target_pred.csv',target_pred_train,delimiter=',')
        np.savetxt('MALD_G_80_mae_train.csv',mae_train_total,delimiter=',')
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MALD_G_80_test_target_pred.csv',target_pred_test,delimiter=',')
        np.savetxt('MALD_G_80_mae_test.csv',mae_test_total,delimiter=',')
