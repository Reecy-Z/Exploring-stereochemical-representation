...
file = 'MALD_features_384.csv'
Train_384 = 'MALD_features_384.csv'
Test_171 = 'MALD_features_171.csv'
Test_216 = 'MALD_features_216.csv'
Test_304 = 'MALD_features_304.csv'

Train_G_384 = 'ee_384.csv'
Test_G_171 = 'ee_171.csv'
Test_G_216 = 'ee_216.csv'
Test_G_304 = 'ee_304.csv'
...
train_loader,valid_loader = get_Train_Test(X=[Train_384,Test_171],Y=[Train_G_384,Test_G_171])
...
for epoch in range(EPOCHS):
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MALD_ee_subset_train_target_pred_'+ 'test_sub-cat'+ '.csv',target_pred_train,delimiter=',')
        np.savetxt('MALD_ee_subset_r2_train_'+ 'test_sub-cat' + '.csv',mae_train_total,delimiter=',')
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MALD_ee_subset_test_target_pred_'+ 'test_sub-cat' + '.csv',target_pred_test,delimiter=',')
        np.savetxt('MALD_ee_subset_r2_test_'+ 'test_sub-cat' + '.csv',mae_test_total,delimiter=',')
