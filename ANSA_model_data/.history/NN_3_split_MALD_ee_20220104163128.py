...
for epoch in range(EPOCHS):
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MALD_ee_subset_train_target_pred_'+ 'test_sub'+ '.csv',target_pred_train,delimiter=',')
        np.savetxt('MALD_ee_subset_r2_train_'+ 'test_sub' + '.csv',mae_train_total,delimiter=',')
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MALD_ee_subset_test_target_pred_'+ 'test_sub' + '.csv',target_pred_test,delimiter=',')
        np.savetxt('MALD_ee_subset_r2_test_'+ 'test_sub' + '.csv',mae_test_total,delimiter=',')
