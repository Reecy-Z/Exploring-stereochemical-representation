...
file = 'features_total_by_sphere.csv'
...
for item, seed in enumerate(range(10)):
    ...
    for epoch in range(EPOCHS):
        ...
        if (epoch+1) == EPOCHS:
            ...
            np.savetxt('FMSD_G_random_train_target_pred_'+ str(seed+1) + '.csv',target_pred_train,delimiter=',')
            np.savetxt('FMSD_G_random_mae_train_'+ str(seed+1) + '.csv',mae_train_total,delimiter=',')
        ...
        if (epoch+1) == EPOCHS:
            ...
            np.savetxt('FMSD_G_random_test_target_pred_'+ str(seed+1) + '.csv',target_pred_test,delimiter=',')
            np.savetxt('FMSD_G_random_mae_test_'+ str(seed+1) + '.csv',mae_test_total,delimiter=',')
