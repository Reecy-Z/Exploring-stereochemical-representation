...
for epoch in range(EPOCHS):
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MAD_G_subset_test_target_pred_'+ 'test_sub-cat' + '.csv',target_pred_test,delimiter=',')
        np.savetxt('MAD_G_subset_mae_test_'+ 'test_sub-cat' + '.csv',mae_test_total,delimiter=',')
