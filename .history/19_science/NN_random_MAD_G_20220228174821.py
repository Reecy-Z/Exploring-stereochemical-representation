...
for item, seed in enumerate(range(10)):
    ...
    for epoch in range(EPOCHS):
        ...
        if (epoch+1) == EPOCHS:
            ...
            np.savetxt('MAD_ee_random_test_target_pred_'+ str(seed+1) + '.csv',target_pred_test,delimiter=',')
            np.savetxt('MAD_ee_random_r2_test_'+ str(seed+1) + '.csv',mae_test_total,delimiter=',')
