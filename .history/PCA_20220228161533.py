...
titles = ['Suzuki-Miyaura coupling','Asymmetric N,S-acetal formation','Buchwald-Hartwig amination']
file = 'D:\\analysis\\data\\PCA\\suzuki\\single_molecule_level.csv'
yield_path = 'D:\\analysis\\data\\PCA\\suzuki\\yields.csv'
...
plt.savefig('C:\\Users\\65416\\Desktop\\molecule.png', dpi = 300)
