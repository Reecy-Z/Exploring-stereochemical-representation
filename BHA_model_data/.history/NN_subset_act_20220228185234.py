...
for epoch in range(EPOCHS):
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MAD_act_subset_train_target_pred_'+ 'test4' + '.csv',target_pred_train,delimiter=',')
        np.savetxt('MAD_act_subset_r2_train_'+ 'test4' + '.csv',r2_train_total,delimiter=',')
    ...
    if (epoch+1) == EPOCHS:
        ...
        np.savetxt('MAD_act_subset_test_target_pred_'+ 'test4' + '.csv',target_pred_test,delimiter=',')
        np.savetxt('MAD_act_subset_r2_test_'+ 'test4' + '.csv',r2_test_total,delimiter=',')
