...
def objective(trial):
    ...
    # Generate the model.
    model = define_model(trial,'features_3960_sun.csv').to(DEVICE)
    ...
    train_loader, valid_loader = get_data('features_3960_sun.csv',1)
    best_r2 = 0
    ...
    for epoch in range(EPOCHS):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            # target = Variable(target.to(torch.float))
            optimizer.zero_grad()
